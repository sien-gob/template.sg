...
import { IGetApisByFilterRepository } from 'src/app/modules/settings/domain/ports/repositories';
import { FilterCondition, SqlFilterBuilder } from 'src/app/modules/shared/common';
import { Injectable } from '@nestjs/common';

@Injectable()
export class GetApisByFilterSqliteRepository implements IGetApisByFilterRepository {
  constructor(private readonly db: Database) {}

  async find(filter: FilterCondition | null | undefined): Promise<ApiEntity[]> {
